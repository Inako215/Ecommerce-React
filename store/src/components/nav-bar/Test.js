const Test = () => {
  return (
    <>
      <nav className="navbar navbar-light navbar-expand-lg fixed-top clean-navbar bg-primary">
        <div className="container">
          ...
          <div id="navcol-1" className="collapse navbar-collapse ">
            {/* <div className="reflow-product-search">
                <div className="ref-input-wrapper">
                  ...
                  />
                  <span className="ref-cancel-search"></span>
                </div>
                <div className="ref-button" type="submit">
                  Search
                </div>
              </div> */}
            <div className="form-inputs w-50 ms-auto d-flex align-items-center">
              <input
